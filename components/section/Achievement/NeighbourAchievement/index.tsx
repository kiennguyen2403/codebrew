...
import { NEIGHBOUR_ACHIEVEMENTS } from "@/utils/constant";

const NeighbourAchievementList = () => {
  return (
    <Stack w={"100%"} h={"100%"} align="center" pos={"relative"}>
      <Title c={"primary"} fw={700} ta={"center"}>
        Neighbour Achievements
      </Title>
      <Flex w={"90vw"} gap={"md"} h={"fit-content"} wrap={"wrap"}>
        {NEIGHBOUR_ACHIEVEMENTS.map((achievement) => (
          <AchievementCard
            key={achievement.id}
...
export default NeighbourAchievementList;
